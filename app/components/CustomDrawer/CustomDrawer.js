    ...
    return (
      ...
      <View style={{ height }}>
        ...
        <View style={{ width: "100%", height: height * 0.7 }}>
          <DrawerInput
            name="Busqueda"
            onHandlePress={() => this.navigation("Main")}
          >
            <Image
          ...
          <DrawerInput
            name="Cuenta"
            onHandlePress={() => this.navigation("Perfil")}
          >
            <Image
              style={{ height: 30, width: 30 }}
              source={require("../../assets/icons/settings-gears.png")}
          ...
          <DrawerInput
            name="Historial"
            onHandlePress={() => this.navigation("History")}
          >
            <Image
              style={{ height: 30, width: 30 }}
          ...
          <DrawerInput
            name="En estudio"
            onHandlePress={() => this.navigation("Study")}
          >
            <Image
              style={{ height: 30, width: 30 }}
          ...
          <DrawerInput
            name="Mis inquilinos"
            onHandlePress={() => this.navigation("Tenants")}
          >
            <Image
              style={{ height: 30, width: 30 }}
